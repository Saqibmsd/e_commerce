    ...
    <header className="w-full bg-white sticky top-0 z-50">
      ...
      <div className="container mx-auto px-4 lg:px-10 flex items-center justify-between h-16 md:h-20 gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="/" className="text-2xl md:text-3xl font-black tracking-tighter text-black">
            SHOP.CO
          </a>
        </div>
        ...
        <nav className="hidden md:flex items-center gap-6">
          ...
          <a href="/new-arrivals" className="hover:text-gray-600 transition-colors whitespace-nowrap">New Arrivals</a>
          <a href="/on-sale" className="hover:text-gray-600 transition-colors whitespace-nowrap">On Sale</a>
          <a href="/casual" className="hover:text-gray-600 transition-colors whitespace-nowrap">Casual</a>
        </nav>
      ...
      {isMenuOpen && (
        <div className="md:hidden absolute top-16 left-0 w-full bg-white border-b border-gray-200 py-4 px-6 flex flex-col gap-4 font-medium animate-in slide-in-from-top-2">
          ...
          <a href="/on-sale" onClick={() => setIsMenuOpen(false)}>On Sale</a>
          <a href="/new-arrivals" onClick={() => setIsMenuOpen(false)}>New Arrivals</a>
          <a href="/casual" onClick={() => setIsMenuOpen(false)}>casual</a>
        </div>
      )}
    </header>
  );
